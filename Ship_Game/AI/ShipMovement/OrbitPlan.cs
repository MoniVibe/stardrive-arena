...
namespace Ship_Game.AI.ShipMovement
{
    internal class OrbitPlan : CombatMovement
    {
        ...
        public void Orbit(Planet orbitTarget, FixedSimTime timeStep)
        {
            ...
            float radius = (orbitTarget.Radius*2 + Owner.Radius).UpperBound(12000);
            ...
            if (!AI.BadGuysNear)
            {
                bool visible = Owner.Universe.Screen?.IsAuthoritative4XMultiplayer == true
                               || orbitTarget.System.InFrustum
