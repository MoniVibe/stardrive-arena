...
public static class AuthoritativeReplicationManifest
{
    static readonly ReplicatedRowDescriptor[] Rows =
    {
        ...
        new("D.DescriptiveFields", "D", "PlayerDesign", "DescriptiveFields",
            AuthoritativeReplicationApplyMode.DigestOnly, AuthoritativeReplicationDigestPolicy.Fatal,
            emit: null, apply: null,
            Fields("Hull", "Role", "BaseCost", "DesignSlotSignature"),
            Array.Empty<string>(),
            "Descriptive design fields remain fatal-digest observed but are not independently replay-applied.",
            knownGap: true, p0Mapping: "P0 D payload-not-applied: Hull, Role, BaseCost, DesignSlotSignature"),
        ...
        new("G.Refit", "G", "EmpireGoal", "Refit",
            ...
            Array.Empty<string>(),
            "Refit goals remain fatal-digest observed but are not replay-applied.",
            knownGap: true, p0Mapping: "P0 G payload-not-applied: all Refit fields", variant: "Refit",
        ...
        new("G.FleetRequisition", "G", "EmpireGoal", "FleetRequisition",
            ...
            Array.Empty<string>(),
            "Fleet requisition goals remain fatal-digest observed but are not replay-applied.",
            knownGap: true, p0Mapping: "P0 G payload-not-applied: all FleetRequisition fields",
        ...
        new("G.DeepSpace", "G", "EmpireGoal", "DeepSpace",
            ...
            Fields("EmpireId", "GoalKind", "GoalType", "Step", "ToBuildName",
                "TargetPlanetId", "TargetSystemId", "TargetShipId", "PlanetBuildingAtId",
                "BuildPosition.X", "BuildPosition.Y", "ExactGoalSet"),
            "Deep-space build state is replayed; emitted MovePosition remains digest-observed only.",
        ...
        new("G.DeepSpaceMovePosition", "G", "EmpireGoal", "DeepSpace.MovePosition",
            AuthoritativeReplicationApplyMode.DigestOnly, AuthoritativeReplicationDigestPolicy.Fatal,
            emit: null, apply: null,
            Fields("MovePosition.X", "MovePosition.Y"), Array.Empty<string>(),
            "DeepSpace MovePosition fields are emitted but not carried into DeepSpaceGoalRuntime.",
            knownGap: true, p0Mapping: "P0 G payload-not-applied: DeepSpace.MovePosition.X/Y",
            variant: "DeepSpace"),
        new("FP.FleetPatrol", "FP", "FleetPatrol", "PlanSignature",
            AuthoritativeReplicationApplyMode.DigestOnly, AuthoritativeReplicationDigestPolicy.Fatal,
            emit: null, apply: null,
            Fields("EmpireId", "FleetPatrolPlanSignature"), Array.Empty<string>(),
            "Fleet patrol definitions are covered by the fatal digest but not replay-patched.",
            knownGap: true, p0Mapping: "P0 FP row: fatal payload-digest row with no replay path.",
            emitStage: AuthoritativeReplicationEmitStage.PerEmpire,
        ...
        new("F.Signatures", "F", "FleetRuntime", "MembershipLayoutPatrolSignatures",
            ...
            Array.Empty<string>(),
            "Fleet membership/layout/patrol signatures remain fatal-digest observed but not replay-applied.",
            knownGap: true,
            p0Mapping: "P0 F payload-not-applied: FleetShipSignature, FleetNodeSignature, FleetPatrolSignature"),
        ...
        new("BP.Blueprint", "BP", "Blueprint", "BlueprintSignature",
            ...
            "Colony blueprints are covered by the fatal digest but not replay-patched.",
            knownGap: true, p0Mapping: "P0 BP row: fatal payload-digest row with no replay path.",
            emitStage: AuthoritativeReplicationEmitStage.PerPlanet,
        ...
        new("T.ColonyTile", "T", "ColonyTile", "ExactTileSet",
            ...
            Fields("PlanetId", "TileX", "TileY", "BuildingName", "Biosphere",
                "Habitable", "Terraformable"),
            Fields("PlanetId", "TileX", "TileY", "BuildingName", "Biosphere",
                "Habitable", "Terraformable", "ExactTileSet"),
            "Tile buildings/biospheres are replayed as an exact host-owned set before digest comparison.",
            emitStage: AuthoritativeReplicationEmitStage.PerPlanet,
        ...
        new("S.PolicyFields", "S", "ShipRuntime", "OwnerTradeCarrierPolicy",
            AuthoritativeReplicationApplyMode.DigestOnly, AuthoritativeReplicationDigestPolicy.Fatal,
            emit: null, apply: null,
            Fields("LoyaltyId", "IsFreighter", "TransportingFood", "TransportingProduction",
                "TransportingColonists", "AllowInterEmpireTrade", "HasFighterBays", "FightersOut",
                "HasTroopBays", "TroopsOut", "RecallFightersBeforeFTL", "SendTroopsToShip",
                "AllowBoardShip", "ManualHangarOverride", "TradeRouteSignature",
                "AreaOfOperationSignature"),
            Array.Empty<string>(),
            "Ship owner/freighter/trade/carrier/hangar/route/operation fields remain fatal-digest observed but not snapshot-repaired.",
            knownGap: true,
            p0Mapping: "P0 S payload-not-applied: LoyaltyId, freighter/trade flags, carrier flags, ManualHangarOverride, TradeRouteSignature, AreaOfOperationSignature"),
